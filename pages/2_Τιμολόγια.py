...
@media(max-width:580px){.kr4,.kr3{grid-template-columns:1fr;}.pw{padding:1rem 1rem 3rem;}}
...
.kc::before{content:'';position:absolute;top:0;left:0;bottom:0;width:3px;background:var(--a,#6b8fd4);}
...
[aria-selected="true"][data-baseweb="tab"]{color:#6b8fd4!important;background:rgba(107,143,212,.08)!important;}
[data-testid="stDataFrame"]{border:1px solid rgba(255,255,255,.07);border-radius:10px;overflow:hidden;}
.info-box{background:rgba(107,143,212,.07);border:1px solid rgba(107,143,212,.2);border-radius:10px;padding:.8rem 1rem;font-size:.73rem;color:rgba(255,255,255,.45);margin:.6rem 0;}
